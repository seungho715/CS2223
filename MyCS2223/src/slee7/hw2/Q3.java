...
public class Q3 {
	...
	static long model(int n) {
		// FIX ME
		double callPower = Math.log(n)/Math.log(2) + n + 1;
		return (long) callPower;
	}
	...
	public static void main(String[] args) {
		...
		for (int n = 2; n <= 4096; n *= 2) {
			...
			long prediction = model(n);
			
			System.out.println(String.format("%6d\t%12d\t%10d\t%11d", n, val, powerCall, prediction));
		}
	}
}